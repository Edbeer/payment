...
func (m *MockStorage) SaveBalance(ctx context.Context, req *authpb.UpdateBalanceRequest) (*types.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorage) UpdateStatement(ctx context.Context, req *authpb.StatementRequest) ([]string, error) {
	m.ctrl.T.Helper()
