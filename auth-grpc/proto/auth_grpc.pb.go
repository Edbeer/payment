...
type AuthService_GetAccountByIDClient interface {
	Send(*GetAccountByIDRequest) error
	Recv() (*Account, error)
	grpc.ClientStream
}
...
func (x *authServiceGetAccountByIDClient) Send(m *GetAccountByIDRequest) error {
...
type AuthService_GetAccountByIDServer interface {
	Send(*Account) error
	Recv() (*GetAccountByIDRequest, error)
	grpc.ServerStream
}
...
func (x *authServiceGetAccountByIDServer) Recv() (*GetAccountByIDRequest, error) {
	m := new(GetAccountByIDRequest)
